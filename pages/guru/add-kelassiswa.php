...
$kelas = mysqli_query($conn, "SELECT * FROM tb_kelassis");
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="container">
                            <h2>Tambah Data Siswa Perkelas</h2>
                            <p>Silahkan jika kalian ingin menambah data, lakukan dengan bijak!</p>
                            <form action="add-fungsikelassiswa.php" method="POST" class="needs-validation" novalidate>
