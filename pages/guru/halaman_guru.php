                            ...
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card" style="width: 18rem;">
                                    <div class="card-body">
                                        ...
                                        $kelas = mysqli_query($conn, "SELECT * FROM tb_kelas inner join tb_jadwal_mapel on tb_jadwal_mapel.kode_kelas = tb_kelas.kode_kelas inner join tb_guru on tb_jadwal_mapel.kode_guru=tb_guru.kode_guru inner join tb_user on tb_user.kode_guru=tb_guru.kode_guru where tb_user.username = '$_SESSION[username]'GROUP BY tb_kelas.kode_kelas");
                            ...
                            <div class="card border-left-warning shadow h-100 py-2">
                                <div class="card" style="width: 18rem;">
                                    <div class="card-body">
                                        ...
                                        $mapel = mysqli_query($conn, "SELECT * FROM tb_jadwal_mapel inner join tb_guru on tb_jadwal_mapel.kode_guru=tb_guru.kode_guru inner join tb_mapel on tb_jadwal_mapel.kode_mapel=tb_mapel.kode_mapel join tb_user on tb_user.kode_guru=tb_guru.kode_guru WHERE username='$_SESSION[username]'");
