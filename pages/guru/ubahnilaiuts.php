...
include "../koneksi.php";
if (isset($_GET['id'])) {
    $tampilnilaimapel = mysqli_query($conn, "SELECT * FROM tb_nilai_uts 
LEFT JOIN tb_mapel on tb_mapel.kode_mapel=tb_nilai_uts.kode_mapel 
LEFT JOIN tb_guru on tb_guru.kode_guru=tb_nilai_uts.kode_guru
WHERE id_nilai_uts = '$_GET[id]'");
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Ubah Data Nilai UTS Siswa</h1>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Data UTS</h6>
                        </div>
                        <div class="container">
                            ...
                            <form action="ubah-fungsinilaiuts.php" method="POST" class="needs-validation" novalidate>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label>Nilai</label>
                                            <input class="form-control" minlength="0" maxlength="3" id=pilih name="nilai" onchange="pilih1();" PLACEHOLDER="ISI NILAI">
                                        </div>
                                        <div class="form-group">
