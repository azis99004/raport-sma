                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="container">
                            ...
                            <form action="ubah-fungsipassword.php" method="POST" class="needs-validation" novalidate>
                                <div class="form-group">
                                    <input type="hidden" name="id_user" value="<?= $result["id_user"]; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="nip">Ubah Password :</label>
                                    <input type="password" class="form-control" id="password" minlength="8" maxlength="8" placeholder="isikan Password baru anda" name="password" maxlength="8">
                                    <div class="valid-feedback">Ok</div>
                                    <div class="invalid-feedback">silahkan input NIP anda</div>
                                </div>
                                <div class="form-group">
                                    <label for="alamat">Retype Password :</label>
                                    <input type="password" class="form-control" id="password2" placeholder="Ketik ulang password baru anda" name="password2" maxlength="8" required>
                                    <div class="valid-feedback">Ok</div>
