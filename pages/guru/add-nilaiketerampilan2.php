...
$nilai = mysqli_query($conn, "SELECT * FROM tb_nilai_keterampilan");
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="container">
                            ...
                            <form action="add-fungsinilaiketerampilan2.php" method="POST" class="needs-validation" novalidate>
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label>Nilai</label>
                                                <input class="form-control" minlength="0" maxlength="3" id=pilih name="nilai_keterampilan" onchange="pilih1();" PLACEHOLDER="ISI NILAI">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="deskripsi" placeholder="Isikan deskripsi" name="deskripsi_keterampilan" required>
