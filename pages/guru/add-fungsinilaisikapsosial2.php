...
if (isset($_POST['tambah'])) {
    ...
    $query = mysqli_query($conn, "INSERT into tb_sikap_sosial (kode_guru,id_siswa, predikat,deskripsi,kode_tahun_akademik) values('$kode_guru','$id_siswa','$predikat','$deskripsi','$kode_tahun_akademik')");
    if ($query) {
