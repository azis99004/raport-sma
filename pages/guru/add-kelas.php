        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Berikut data-data Kelas yang telah terdaftar!
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="container">
                            ...
                            <form action="add-fungsikelas.php" method="POST" class="needs-validation" novalidate>
                                <div class="form-group">
                                    <label for="sel1">Kode Ruangan:</label>
                                    <select class="form-control" id="sel1" name="kode_ruangan" required>
                                        <option value="">--Pilih Kode Ruangan:</option>
                                        <?php
                                        include "../koneksi.php";
                                        $tampilruangan = mysqli_query($conn, "SELECT * FROM tb_ruangan");
                                        while ($ruangan = mysqli_fetch_assoc($tampilruangan)) {
                                            echo "<option value=$ruangan[kode_ruangan]>$ruangan[kode_ruangan]</option>";
                                        }
                                        ?>
                                    </select>
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="sel1" name="kode_guru" required>
                                            ...
                                            <?php
                                            include "../koneksi.php";
                                            $tampilguru = mysqli_query($conn, "SELECT * FROM tb_guru");
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="alamat" placeholder="Isikan Nama Kelas" name="nama_kelas" required>
