...
$siswa = mysqli_query($conn, "SELECT * FROM tb_absen");
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Tambahkan Kehadiran Siswa</h1>
                    <p class="mb-4">Silahkan melakukan penambahan absensi siswa ingat, selalu gunakan dengan bijak!

                        <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Tambah Absensi Siswa</h6>
                        </div>
                        <div class="container">
                            <h2>Tambah Data</h2>
                            <p>Silahkan jika kalian ingin menambah data, lakukan dengan bijak!</p>
                            <form action="add-fungsiabsensiswa.php" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="sel1" name="kode_mapel" required>
                                                ...
                                                <?php
                                                include "../koneksi.php";
                                                $tampilnilaimapel = mysqli_query($conn, "SELECT * FROM tb_jadwal_mapel inner join tb_guru on tb_jadwal_mapel.kode_guru=tb_guru.kode_guru inner join tb_mapel on tb_jadwal_mapel.kode_mapel=tb_mapel.kode_mapel join tb_user on tb_user.kode_guru=tb_guru.kode_guru WHERE username='$_SESSION[username]'");
                                                while ($nilaimapel = mysqli_fetch_assoc($tampilnilaimapel)) {
                                            ...
                                            <div class="form-group">
                                                <label for="sel1">Kehadiran</label>
                                                <select class="form-control" id="sel1" name="kehadiran">
                                                    <option>Sakit</option>
                                                    <option>Izin</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="kelamin" placeholder="Isikan Deskripsi" name="deskripsi" required>
