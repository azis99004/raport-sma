...
include "../koneksi.php";
if (isset($_GET['id'])) {
    $tampilguru = mysqli_query($conn, "SELECT * FROM tb_guru WHERE kode_guru = '$_GET[id]'");
    $guru = mysqli_fetch_assoc($tampilguru);
}
?>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="pilih-kelas.php">Pilih Kelas</a>
                    </div>
                </div>
            </li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="container">
                            ...
                            <form action="ubah-fungsiguru.php" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
                                <div class="form-group">
                                    <input type="hidden" name="kode_guru" value="<?= $guru["kode_guru"]; ?>">
                                    <input type="hidden" name="foto_guruLama" value="<?= $guru["foto_guru"]; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="nama">Nama Guru :</label>
                                    <input type="text" class="form-control" id="nip" placeholder="isikan Nama Anda" name="nama_guru" value="<?= $guru['nama_guru']; ?>">
                                    <div class="valid-feedback">Ok</div>
                                    <div class="invalid-feedback">silahkan input Nama anda</div>
                                </div>
                                <div class="form-group">
                                    <label for="nip">NIP :</label>
                                    <input type="text" class="form-control" id="nip" placeholder="isikan NIP anda" name="nip" value="<?= $guru['nip']; ?>">
                                    <div class="valid-feedback">Ok</div>
                                    <div class="invalid-feedback">silahkan input NIP anda</div>
                                </div>
                                <div class="form-group">
                                    <label for="alamat">Alamat Guru :</label>
                                    <input type="text" class="form-control" id="alamat" placeholder="Isikan Alamat Lengkap Anda" name="alamat_guru" value="<?= $guru["alamat_guru"]; ?>">
                                    <div class="valid-feedback">Ok</div>
                                    <div class="invalid-feedback">Silahkan Isi Alamat Anda</div>
                                </div>
                                <div class="form-group">
                                    <label for="telp">Telpon Guru :</label>
                                    <input type="text" class="form-control" id="telp" placeholder="Isikan No. Telpon Anda" name="telp_guru" value="<?= $guru["telp_guru"]; ?>">
                                    <div class="valid-feedback">Ok</div>
                                    <div class="invalid-feedback">silahkan input nomor telpon anda</div>
                                </div>
                                <div class="form-group">
                                    <label for="telp">Foto Guru :</label><br>
                                    <img src="../../img/<?= $guru['foto_guru']; ?>" width="100"><br>
                                    <input type="file" <i class="fas fa-cloud-upload-alt" class="form-control" id="kelamin" placeholder="Isikan foto siswa" name="foto_guru" required></i>
                                    <div class="valid-feedback">Ok</div>
                                    <div class="invalid-feedback">silahkan Masukkan foto siswa</div>
                                </div>
