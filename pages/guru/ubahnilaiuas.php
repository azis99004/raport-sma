...
include "../koneksi.php";
if (isset($_GET['id'])) {
    $tampilnilaimapel = mysqli_query($conn, "SELECT * FROM tb_nilai_uas 
    LEFT JOIN tb_mapel on tb_mapel.kode_mapel=tb_nilai_uas.kode_mapel 
    LEFT JOIN tb_guru on tb_guru.kode_guru=tb_nilai_uas.kode_guru
    WHERE id_nilai_uas = '$_GET[id]'");
