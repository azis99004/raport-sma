...
$guru = mysqli_query($conn, "SELECT * FROM tb_guru inner join tb_user on tb_user.username = tb_user.username WHERE tb_guru.kode_guru='$_GET[id]' AND tb_user.username = '$_SESSION[username]'");
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <table class="table table-bordered table-striped">
                            <tr>
                                <th rowspan="11px" width="170"><?php echo "<img src=\"../../img/$result[foto_guru]\" width=\"150px\"/>" ?></th>
                            <tr>
                                <th align="left">Nama Guru</th>
                                <th>: </th>
                                <td align="left"><?php echo "$result[nama_guru]"; ?></td>
                            </tr>
                            <tr>
                                <th align="left">Alamat Guru</th>
                                <th>: </th>
                                <td align="left"><?php echo "$result[alamat_guru]"; ?></td>
                            </tr>
                            <tr>
                                <th align="left" valign="top">Telpon Guru</th>
                                <th valign="top">: </th>
                                <td align="left" valign="top"><?php echo "$result[telp_guru]"; ?></td>
                            </tr>
                        </table>
                        Ubah Biodata Guru :
                        <td>
                            <button type="button" name="ubah"><a href="ubahguru.php?id=<?= $result["kode_guru"] ?>"><i class="fas fa-pencil-alt"></i></a></button>
                        </td>
                        Ubah Password Anda :
                        <td>
