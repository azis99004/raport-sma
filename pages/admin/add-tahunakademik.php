...
$nilai = mysqli_query($conn, "SELECT * FROM tb_tahun_akademik");
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Tambah Data Nilai UAS Siswa</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="container">
                            ...
                            <form action="add-fungsitahunakademik.php" method="POST" class="needs-validation" novalidate>
                                <div class="form-group">
                                    <label for="deskripsi">Nama Tahun Akademik</label>
                                    <input type="text" class="form-control" id="deskripsi" placeholder="Isikan tahun akademik" name="nama_tahun_akademik" required>
