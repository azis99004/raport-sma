...
include "../koneksi.php";
if (isset($_GET['id'])) {
    $tampilkelassis = mysqli_query($conn, "SELECT * FROM tb_sikap WHERE kode_sikap = '$_GET[id]'");
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="container">
                            ...
                            <form action="ubah-fungsinilaisikap.php" method="POST" class="needs-validation" novalidate>
                                <div class="form-group">
                                    <input type="hidden" name="kode_sikap" value="<?= $kelassis["kode_sikap"]; ?>">
                                </div>
                                <div class="form-group">
