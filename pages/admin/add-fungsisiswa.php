...
if (isset($_POST['tambah'])) {
    ...
    $query = mysqli_query($conn, "INSERT into tb_siswa (kode_kelas,nisn, jurusan, nama_siswa, tgl_lahir, kelamin, tempat_lahir, agama, no_hp, email, foto_siswa) values('$kode_kelas','$nisn','$jurusan','$nama_siswa','$tgl_lahir','$kelamin','$tempat_lahir','$agama','$no_hp','$email','$foto_siswa')");
    if ($query) {
