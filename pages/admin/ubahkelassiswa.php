...
include "../koneksi.php";
if (isset($_GET['id'])) {
    $tampilkelassis = mysqli_query($conn, "SELECT * FROM tb_kelassis WHERE kode_kelassis = '$_GET[id]'");
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Ubah Data Siswa dan Kelas</h1>
                    <p class="mb-4">Silahkan ubah data-data siswa yang ingin diubah kelasnya !
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="container">
                            ...
                            <form action="ubah-fungsikelassis.php" method="POST" class="needs-validation" novalidate>
                                <div class="form-group">
                                    <input type="hidden" name="kode_kelassis" value="<?= $kelassis["kode_kelassis"]; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="sel1">Siswa:</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="sel1" name="kode_kelas" required>
                                            ...
                                            while ($w = mysqli_fetch_array($tampil)) {
                                                if ($kelassis['kode_kelas'] == $w['kode_kelas']) {
