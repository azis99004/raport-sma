...
include "../koneksi.php";
if (isset($_GET['id'])) {
    $tampilnilaimapel = mysqli_query($conn, "SELECT * FROM tb_kelas inner join tb_ruangan on tb_ruangan.kode_ruangan=tb_kelas.kode_ruangan WHERE kode_kelas = '$_GET[id]'");
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="container">
                            <h2>Ubah Kelas</h2>
                            <p>Ubah data kelas dengan bijak!</p>
                            <form action="ubah-fungsikelas.php" method="POST" class="needs-validation" novalidate>
                                <div class="form-group">
                                    <input type="hidden" name="kode_kelas" value="<?= $nilaimapel["kode_kelas"]; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="sel1" readonly>Ruangan :</label>
                                    <select class="form-control" id="sel1" name="kode_ruangan" required>
                                        <?php
                                        $tampil = mysqli_query($conn, "SELECT * FROM tb_ruangan ORDER BY kode_ruangan");
                                        while ($w = mysqli_fetch_array($tampil)) {
                                            if ($nilaimapel['kode_ruangan'] == $w['kode_ruangan']) {
                                                echo "<option value=$w[kode_ruangan] selected>$w[nama_ruangan]</option>";
                                            } else {
                                                echo "<option value=$w[kode_ruangan]>$w[nama_ruangan]</option>";
                                            }
                                        }
                                        ?>
                                    </select>
