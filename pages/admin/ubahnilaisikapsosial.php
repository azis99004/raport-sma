...
include "../koneksi.php";
if (isset($_GET['id'])) {
    $tampilkelassis = mysqli_query($conn, "SELECT * FROM tb_sikap_sosial WHERE kode_sikap_sosial = '$_GET[id]'");
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Ubah Data Nilai Sikap Siswa</h1>
                    <p class="mb-4">Silahkan ubah data nilai sikap siswa yang ingin diubah!

                        <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Data Nilai Sikap Siswa</h6>
                        </div>
                        <div class="container">
                            <h2>Ubah Data</h2>
                            <p>Silahkan jika kalian ingin mengubah data, lakukan dengan bijak!</p>
                            <form action="ubah-fungsinilaisikapsosial.php" method="POST" class="needs-validation" novalidate>
                                <div class="form-group">
                                    <input type="hidden" name="kode_sikap_sosial" value="<?= $kelassis["kode_sikap_sosial"]; ?>">
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="sel1" name="kode_guru" required>
                                        ...
                                        while ($w = mysqli_fetch_array($tampil)) {
                                            if ($kelassis['kode_guru'] == $w['kode_guru']) {
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="alamat">Predikat :</label>
                                            <input type="text" class="form-control" id="nilai" placeholder="Isikan Alamat Lengkap Anda" name="predikat" value="<?= $kelassis["predikat"]; ?>">
