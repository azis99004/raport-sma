            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="container">
                            <h2>Tambah Data User Guru Baru!</h2>
                            <p>Silahkan jika kalian ingin menambah data, lakukan dengan bijak!</p>
                            <form action="add-fungsiuserguru.php" method="POST" class="needs-validation" novalidate>
                                <div class="form-group">
                                    <label for="kode_guru">Nama Guru:</label>
                                    <select class="selectpicker form-control" data-live-search="true" id="kode_guru" name="kode_guru" required>
