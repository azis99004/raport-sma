...
$nilai = mysqli_query($conn, "SELECT * FROM tb_extrakulikuler");
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Data Nilai Extrakulikuler Siswa</h1>
                    <p class="mb-4">Nilai Siswa

                        <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Data Extrakulikuler Siswa</h6>
                        </div>
                        <div class="container">
                            <h2>Tambah Data</h2>
                            <p>Silahkan jika kalian ingin menambah data, lakukan dengan bijak!</p>
                            <form action="add-fungsinilaiextra.php" method="POST" class="needs-validation" novalidate>
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="sel1" name="id_siswa" required>
                                        ...
                                        <?php
                                        include "../koneksi.php";
                                        $tampilsiswa = mysqli_query($conn, "SELECT * FROM tb_siswa");
                                        while ($siswa = mysqli_fetch_assoc($tampilsiswa)) {
