            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="container">
                            <h2>Tambah Data User Admin Baru!</h2>
                            <p>Silahkan jika kalian ingin menambah data, lakukan dengan bijak!</p>
                            <form action="add-fungsiuseradmin.php" method="POST" class="needs-validation" novalidate>
                                <div class="form-group">
                                    <label for="kode_guru">Nama Admin:</label>
                                    <select class="form-control" id="sel1" name="id_admin" required>
                                        <option value="">--Pilih Nama Admin:</option>
                                        <?php
                                        include "../koneksi.php";
                                        $tampilguru = mysqli_query($conn, "SELECT * FROM tb_admin");
                                        while ($guru = mysqli_fetch_assoc($tampilguru)) {
                                            echo "<option value=$guru[id_admin]>$guru[nama_admin]</option>";
                                        }
                                        ?>
                                    </select>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" id="password" minlength="8" maxlength="8" placeholder="isikan Password" name="password">
                                        <div class="valid-feedback">Ok</div>
                                        <div class="invalid-feedback">silahkan input NIP anda</div>
                                    </div>
                                    <div class="form-group">
                                        <label for="alamat">Retype Password :</label>
                                        <input type="password" class="form-control" id="password2" minlength="8" maxlength="8" placeholder="Ketik ulang password anda" name="password2" required>
                                        <div class="valid-feedback">Ok</div>
