...
include "../koneksi.php";
if (isset($_GET['id'])) {
    $tampilkelassis = mysqli_query($conn, "SELECT * FROM tb_tahun_akademik WHERE kode_tahun_akademik = '$_GET[id]'");
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Ubah Data Tahun Akademik</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="container">
                            ...
                            <form action="ubah-fungsitahunakademik.php" method="POST" class="needs-validation" novalidate>
                                <div class="form-group">
                                    <input type="hidden" name="kode_tahun_akademik" value="<?= $kelassis["kode_tahun_akademik"]; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="deskripsi">Deskripsi :</label>
                                    <input type="text" class="form-control" id="nilai" placeholder="Isikan Alamat Lengkap Anda" name="nama_tahun_akademik" value="<?= $kelassis["nama_tahun_akademik"]; ?>">
