                        ...
                        <div class="container">
                            ...
                            <form action="ubah-fungsisiswa.php" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nisn" placeholder="Isikan NISN siswa" name="nisn" autofocus maxlength="12" minlength="12" value="<?= $siswa['nisn']; ?>">
                                    <div class="valid-feedback">Ok</div>
                                    <div class="invalid-feedback">silahkan input kode mapel</div>
                                </div>
                                <div class="form-group">
                                    <label for="sel1">Kelas:</label>
                                    <select class="form-control" id="sel1" name="kode_kelas">
                                        <?php
                                        $tampil = mysqli_query($conn, "SELECT * FROM tb_kelas ORDER BY kode_kelas");
                                        while ($w = mysqli_fetch_array($tampil)) {
                                            if ($siswa['kode_kelas'] == $w['kode_kelas']) {
