...
include "../koneksi.php";
if (isset($_GET['id'])) {
    $tampilnilaimapel = mysqli_query($conn, "SELECT * FROM tb_nilai_keterampilan WHERE id_nilai_keterampilan = '$_GET[id]'");
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="container">
                            ...
                            <form action="ubah-fungsinilaiketerampilan.php" method="POST" class="needs-validation" novalidate>
                                <div class="form-group">
                                    <input type="hidden" name="id_nilai_keterampilan" value="<?= $nilaimapel["id_nilai_keterampilan"]; ?>">
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="sel1" name="id_siswa" required>
                                            ...
                                            while ($w = mysqli_fetch_array($tampil)) {
                                                if ($nilaimapel['id_siswa'] == $w['id_siswa']) {
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label>Nilai</label>
                                                <input class="form-control" id=pilih name="nilai_keterampilan" onchange="pilih1();" PLACEHOLDER="ISI NILAI">
                                            </div>
                                            <div class="form-group">
                                                <input type=hidden class="form-control" id=n name="grade_keterampilan"> </input>
                                            </div>
                                            <div class="form-group">
                                                <label for="deskripsi"> Deskripsi:</label>
                                                <input type="text" class="form-control" id="deskripsi" placeholder="Isikan Nilai" name="deskripsi_keterampilan" value="<?= $nilaimapel["deskripsi_keterampilan"]; ?>">
                                                <div class="valid-feedback">Ok</div>
                                                <div class="invalid-feedback">silahkan input nomor telpon anda</div>
                                            </div>
                                            <div class="form-group">
                                                <label for="sel1" readonly>Tahun Akademik:</label>
                                                <select class="form-control" id="sel1" name="kode_tahun_akademik" required>
                                                    <?php
                                                    $tampil = mysqli_query($conn, "SELECT * FROM tb_tahun_akademik ORDER BY kode_tahun_akademik");
                                                    while ($w = mysqli_fetch_array($tampil)) {
                                                        if ($nilaimapel['kode_tahun_akademik'] == $w['kode_tahun_akademik']) {
                                                            echo "<option value=$w[kode_tahun_akademik] selected>$w[nama_tahun_akademik]</option>";
                                                        } else {
                                                            echo "<option value=$w[kode_mapel]>$w[nama_mapel]</option>";
                                                        }
                                                    }
