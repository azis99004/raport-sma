...
if (isset($_POST['tambah'])) {
    ...
    $query = mysqli_query($conn, "INSERT into tb_nilai_keterampilan (kode_mapel,kode_guru, id_siswa,nilai_keterampilan, grade_keterampilan, deskripsi_keterampilan, kode_tahun_akademik) values('$kode_mapel','$kode_guru','$id_siswa','$nilai','$grade','$deskripsi','$kode_tahun_akademik')");
    if ($query) {
