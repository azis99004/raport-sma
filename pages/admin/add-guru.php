        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Berikut data-data guru yang telah terdaftar!
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="container">
                            ...
                            <form action="add-fungsiguru.php" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="nama">Nama Guru :</label>
                                    <input type="text" class="form-control" id="nip" placeholder="isikan Nama Anda" name="nama_guru" required>
                                    <div class="valid-feedback">Ok</div>
                                    <div class="invalid-feedback">silahkan input Nama anda</div>
                                </div>
                                <div class="form-group">
                                    <label for="nip">NIP :</label>
                                    <input type="text" class="form-control" id="nip" placeholder="isikan NIP anda" name="nip" minlength="12" maxlength="12">
                                    <div class="valid-feedback">Ok</div>
                                    <div class="invalid-feedback">silahkan input NIP anda</div>
                                </div>
                                <div class="form-group">
                                    <label for="alamat">Alamat Guru :</label>
                                    <input type="text" class="form-control" id="alamat" placeholder="Isikan Alamat Lengkap Anda" name="alamat_guru" required>
                                    <div class="valid-feedback">Ok</div>
                                    <div class="invalid-feedback">Silahkan Isi Alamat Anda</div>
                                </div>
                                <div class="form-group">
                                    <label for="telp">Telpon Guru :</label>
                                    <input type="text" class="form-control" id="telp" placeholder="Isikan No. Telpon Anda" name="telp_guru" required minlength="12" maxlength="12">
                                    <div class="valid-feedback">Ok</div>
                                    <div class="invalid-feedback">silahkan input nomor telpon anda</div>
                                </div>
                                <div class="form-group">
                                    <label for="foto_guru">Foto Guru :</label> <br>
