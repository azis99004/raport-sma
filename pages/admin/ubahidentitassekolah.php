...
include "../koneksi.php";
if (isset($_GET['id'])) {
    $tampilmapel = mysqli_query($conn, "SELECT * FROM tb_identitas_sekolah WHERE kode_identitas_sekolah = '$_GET[id]'");
    $mapel = mysqli_fetch_assoc($tampilmapel);
}
?>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Ubah Data Identitas Sekolah</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="container">
                            <h2>Ubah Data</h2>
                            <p>Silahkan jika kalian ingin mengubah data, lakukan dengan bijak!</p>
                            <form action="ubah-fungsiidentitassekolah.php" method="POST" class="needs-validation" novalidate>
                                <div class="form-group">
                                    <input type="hidden" class="form-control" id="kode" placeholder="Isikan Kode Mapel yang di inginkan" name="kode_identitas_sekolah" autofocus readonly value="<?php global $mapel; ?><?php echo $mapel['kode_identitas_sekolah']; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="nama">Nama Sekolah :</label>
                                    <input type="text" class="form-control" id="nip" placeholder="isikan Nama Anda" name="nama_sekolah" value="<?= $mapel['nama_sekolah']; ?>">
                                    <div class="valid-feedback">Ok</div>
                                    <div class="invalid-feedback">silahkan input Nama anda</div>
                                </div>
                                <div class="form-group">
                                    <label for="nama">NPSN :</label>
                                    <input type="text" class="form-control" id="nip" placeholder="isikan Nama Anda" name="npsn" value="<?= $mapel['npsn']; ?>">
                                    <div class="valid-feedback">Ok</div>
                                    <div class="invalid-feedback">silahkan input Nama anda</div>
                                </div>
                                <div class="form-group">
                                    <label for="nama">NSS :</label>
                                    <input type="text" class="form-control" id="nip" placeholder="isikan Nama Anda" name="nss" value="<?= $mapel['nss']; ?>">
                                    <div class="valid-feedback">Ok</div>
                                    <div class="invalid-feedback">silahkan input Nama anda</div>
                                </div>
                                <div class="form-group">
                                    <label for="nama">Alamat Sekolah :</label>
                                    <input type="text" class="form-control" id="nip" placeholder="isikan Nama Anda" name="alamat_sekolah" value="<?= $mapel['alamat_sekolah']; ?>">
                                    <div class="valid-feedback">Ok</div>
                                    <div class="invalid-feedback">silahkan input Nama anda</div>
                                </div>
                                <div class="form-group">
                                    <label for="nama">Kode Pos :</label>
                                    <input type="text" class="form-control" id="nip" placeholder="isikan Nama Anda" name="kode_pos" value="<?= $mapel['kode_pos']; ?>">
                                    <div class="valid-feedback">Ok</div>
                                    <div class="invalid-feedback">silahkan input Nama anda</div>
                                </div>
                                <div class="form-group">
                                    <label for="nama">No Telepon :</label>
                                    <input type="text" class="form-control" id="nip" placeholder="isikan Nama Anda" name="no_telpon" value="<?= $mapel['no_telpon']; ?>">
                                    <div class="valid-feedback">Ok</div>
                                    <div class="invalid-feedback">silahkan input Nama anda</div>
                                </div>
                                <div class="form-group">
                                    <label for="nama">Kelurahan :</label>
                                    <input type="text" class="form-control" id="nip" placeholder="isikan Nama Anda" name="kelurahan" value="<?= $mapel['kelurahan']; ?>">
                                    <div class="valid-feedback">Ok</div>
                                    <div class="invalid-feedback">silahkan input Nama anda</div>
                                </div>
                                <div class="form-group">
                                    <label for="nama">Kecamatan :</label>
                                    <input type="text" class="form-control" id="nip" placeholder="isikan Nama Anda" name="kecamatan" value="<?= $mapel['kecamatan']; ?>">
                                    <div class="valid-feedback">Ok</div>
                                    <div class="invalid-feedback">silahkan input Nama anda</div>
                                </div>
                                <div class="form-group">
                                    <label for="nama">Kabupaten :</label>
                                    <input type="text" class="form-control" id="nip" placeholder="isikan Nama Anda" name="kabupaten_kota" value="<?= $mapel['kabupaten_kota']; ?>">
                                    <div class="valid-feedback">Ok</div>
                                    <div class="invalid-feedback">silahkan input Nama anda</div>
                                </div>
                                <div class="form-group">
                                    <label for="nama">Provinsi :</label>
                                    <input type="text" class="form-control" id="nip" placeholder="isikan Nama Anda" name="provinsi" value="<?= $mapel['provinsi']; ?>">
                                    <div class="valid-feedback">Ok</div>
                                    <div class="invalid-feedback">silahkan input Nama anda</div>
                                </div>
                                <div class="form-group">
                                    <label for="nama">Website :</label>
                                    <input type="text" class="form-control" id="nip" placeholder="isikan Nama Anda" name="website" value="<?= $mapel['website']; ?>">
                                    <div class="valid-feedback">Ok</div>
                                    <div class="invalid-feedback">silahkan input Nama anda</div>
                                </div>
                                <div class="form-group">
                                    <label for="nama">Email :</label>
                                    <input type="email" class="form-control" id="nip" placeholder="isikan Nama Anda" name="email" value="<?= $mapel['email']; ?>">
                                    <div class="valid-feedback">Ok</div>
                                    <div class="invalid-feedback">silahkan input Nama anda</div>
                                </div>
