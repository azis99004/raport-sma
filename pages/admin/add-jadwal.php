...
$nilai = mysqli_query($conn, "SELECT * FROM tb_jadwal_mapel");
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Data Nilai Harian Siswa</h1>


                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Data Nilai Harian Siswa</h6>
                        </div>
                        <div class="container">
                            <h2>Tambah Data</h2>
                            <p>Silahkan jika kalian ingin menambah data, lakukan dengan bijak!</p>
                            <form action="add-fungsijadwal.php" method="POST" class="needs-validation" novalidate>
                                <div class="form-group">
                                    <label for="sel1">Nama Kelas:</label>
                                    <select class="selectpicker form-control" data-live-search="true" id="sel1" name="kode_kelas" required>
                                        <option value="">--Pilih Nama Kelas:</option>
                                        <?php
                                        include "../koneksi.php";
                                        $tampilnilaimapel = mysqli_query($conn, "SELECT * FROM tb_kelas");
                                        while ($nilaimapel = mysqli_fetch_assoc($tampilnilaimapel)) {
                                            echo "<option value=$nilaimapel[kode_kelas]>$nilaimapel[nama_kelas]</option>";
                                        }
                                        ?>
                                    </select>
                                    <div class="form-group">
                                        <label for="sel1">Nama Mapel:</label>
                                        <select class="selectpicker form-control" data-live-search="true" id="sel1" name="kode_mapel" required>
                                            <option value="">--Pilih Mapel:</option>
                                            <?php
                                            include "../koneksi.php";
                                            $tampilnilaimapel = mysqli_query($conn, "SELECT * FROM tb_mapel");
                                            while ($nilaimapel = mysqli_fetch_assoc($tampilnilaimapel)) {
                                                echo "<option value=$nilaimapel[kode_mapel]>$nilaimapel[nama_mapel]->$nilaimapel[tingkat]->$nilaimapel[jurusan]</option>";
                                            }
                                            ?>
                                        </select>
                                        <div class="form-group">
                                            <label for="sel1">Nama Guru:</label>
                                            <select class="selectpicker form-control" data-live-search="true" id="sel1" name="kode_guru" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="time" class="form-control" id="deskripsi" placeholder="Isikan deskripsi" name="jam_mulai" required>
                                                <div class="valid-feedback">Ok</div>
                                                <div class="invalid-feedback">Silahkan Isi Alamat Anda</div>
                                            </div>
                                            <div class="form-group">
                                                <label for="deskripsi">Jam Selesai :</label>
                                                <input type="time" class="form-control" id="deskripsi" placeholder="Isikan deskripsi" name="jam_selesai" required>
                                                <div class="valid-feedback">Ok</div>
                                                <div class="invalid-feedback">Silahkan Isi Alamat Anda</div>
                                            </div>
                                            <div class="form-group">
