...
$guru = mysqli_query($conn, "SELECT * FROM tb_walas inner join tb_guru on tb_walas.kode_guru=tb_guru.kode_guru inner join tb_user on tb_user.username = tb_user.username WHERE tb_walas.kode_walas='$_GET[id]' AND tb_user.username = '$_SESSION[username]'");
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <table class="table table-bordered table-striped">
                            <tr>
                                <th align="left">Nama Wali Kelas</th>
                                <th>: </th>
