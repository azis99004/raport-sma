            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="container">
                            <h2>Tambah Data User Siswa</h2>
                            <p>Silahkan jika kalian ingin menambah data, lakukan dengan bijak!</p>
                            <form action="add-fungsiuser.php" method="POST" class="needs-validation" novalidate>
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="nama" placeholder="isikan Username" name="nama" title="8 Character Username" maxlength="8" required>
                                        <div class="valid-feedback">Ok</div>
                                        <div class="invalid-feedback">silahkan input Nama anda</div>
                                    </div>
                                    <div class="form-group">
                                        <label for="nip">Password :</label>
                                        <input type="password" class="form-control" id="password" placeholder="isikan Password" name="password" maxlength="8">
                                        <div class="valid-feedback">Ok</div>
                                        <div class="invalid-feedback">silahkan input NIP anda</div>
                                    </div>
                                    <div class="form-group">
                                        <label for="alamat">Retype Password :</label>
                                        <input type="password" class="form-control" id="password2" placeholder="Ketik ulang password anda" name="password2" maxlength="8" required>
                                        <div class="valid-feedback">Ok</div>
