...
if (isset($_POST['tambah'])) {
    ...
    $query = mysqli_query($conn, "INSERT into tb_nilai_keterampilan (kode_mapel,kode_guru, id_siswa,nilai, grade, deskripsi) values('$kode_mapel','$kode_guru','$id_siswa','$nilai','$grade','$deskripsi')");
    if ($query) {
