...
$nilai = mysqli_query($conn, "SELECT * FROM tb_keputusan_walas");
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="container">
                            ...
                            <form action="add-fungsikeputusanwalas.php" method="POST" class="needs-validation" novalidate>
                                <div class="form-group">
                                    <label for="sel1">Nama Guru:</label>
                                    <select class="form-control" id="sel1" name="kode_walas" required>
                                        <option value="">--Pilih Nama Guru:</option>
                                        <?php
                                        include "../koneksi.php";
                                        $tampilnilaimapel = mysqli_query($conn, "SELECT * FROM tb_walas inner join tb_user on tb_user.kode_walas=tb_walas.kode_walas left join tb_guru on tb_walas.kode_guru=tb_guru.kode_guru WHERE username='$_SESSION[username]'");
                                        while ($nilaimapel = mysqli_fetch_assoc($tampilnilaimapel)) {
                                            echo "<option value=$nilaimapel[kode_walas]>$nilaimapel[nama_guru]</option>";
                                        }
                                        ?>
                                    </select>
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="deskripsi">Keputusan :</label>
                                            <input type="text" class="form-control" id="deskripsi" placeholder="Isikan deskripsi" name="keputusan" required>
