...
$nilai = mysqli_query($conn, "SELECT * FROM tb_absen_total");
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="container">
                            ...
                            <form action="add-fungsi-total-absen.php" method="POST" class="needs-validation" novalidate>
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="deskripsi">Sakit :</label>
                                        <input type="text" class="form-control" id="deskripsi" placeholder="Silahkan Masukan Jumlah Sakit" name="sakit" required>
                                        <div class="valid-feedback">Ok</div>
                                        <div class="invalid-feedback">Silahkan Masukan Jumlah Sakit</div>
                                    </div>
                                    <div class="form-group">
                                        <label for="deskripsi">Izin :</label>
                                        <input type="text" class="form-control" id="deskripsi" placeholder="Silahkan Masukan Jumlah Izin Siswa" name="izin" required>
                                        <div class="valid-feedback">Ok</div>
                                        <div class="invalid-feedback">Silahkan Masukan Jumlah Izin Siswa</div>
                                    </div>
                                    <div class="form-group">
                                        <label for="deskripsi">Tanpa Keterangan :</label>
                                        <input type="text" class="form-control" id="deskripsi" placeholder="Silahkan masukkan total tanpa keterangan siswa" name="tanpa_keterangan" required>
                                        <div class="valid-feedback">Ok</div>
                                        <div class="invalid-feedback">Silahkan masukkan total tanpa keterangan siswa</div>
                                    </div>
                                    <div class="form-group">
