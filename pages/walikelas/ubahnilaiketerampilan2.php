                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="container">
                            ...
                            <form action="ubah-fungsinilaiketerampilan2.php" method="POST" class="needs-validation" novalidate>
                                <div class="form-group">
                                    <input type="hidden" name="id_nilai_keterampilan" value="<?= $nilaimapel["id_nilai_keterampilan"]; ?>">
                                    <div class="form-group">
                                        <label for="nilai"> Kode Mapel:</label>
                                        <input type="text" class="form-control" id="kode_mapel" placeholder="Isikan Nilai" name="kode_mapel" readonly value="<?= $nilaimapel["kode_mapel"]; ?>">
                                        <div class="valid-feedback">Ok</div>
                                        <div class="invalid-feedback">silahkan input nomor telpon anda</div>
                                    </div>
                                    <div class="form-group">
                                        <label for="nilai"> Kode Guru:</label>
                                        <input type="text" class="form-control" id="kode_guru" placeholder="Isikan Nilai" name="kode_guru" readonly value="<?= $nilaimapel["kode_guru"]; ?>">
                                        <div class="valid-feedback">Ok</div>
                                        <div class="invalid-feedback">silahkan input nomor telpon anda</div>
                                    </div>
                                    <div class="form-group">
                                        <label for="id_siswa"> ID Siswa:</label>
                                        <input type="text" class="form-control" id="id_siswa" placeholder="Isikan Nilai" name="id_siswa" readonly value="<?= $nilaimapel["id_siswa"]; ?>">
                                        <div class="valid-feedback">Ok</div>
                                        <div class="invalid-feedback">silahkan input nomor telpon anda</div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="deskripsi" placeholder="Isikan Nilai" name="deskripsi" value="<?= $nilaimapel["deskripsi"]; ?>">
                                        <div class="valid-feedback">Ok</div>
                                        <div class="invalid-feedback">silahkan input nomor telpon anda</div>
                                    </div>
