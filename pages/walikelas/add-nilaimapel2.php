                            ...
                            <form action="add-fungsinilaimapel2.php" method="POST" class="needs-validation" novalidate>
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="sel1" name="kode_guru" required>
                                        ...
                                        <?php
                                        include "../koneksi.php";
                                        $tampilnilaimapel = mysqli_query($conn, "SELECT * FROM tb_user JOIN tb_walas ON tb_walas.kode_walas = tb_user.kode_walas join tb_guru on tb_walas.kode_guru = tb_guru.kode_guru where username ='$_SESSION[username]'");
