        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
                    ...
                    <span>Input Nilai dan Print</span>
                </a>
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="pilihtahun.php">Print Raport</a>
                    </div>
                </div>
            </li>
            <!-- Nav Item - Pages Collapse Menu -->
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="pilihtahun.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Raport Siswa</a>
                    </div>
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card" style="width: 18rem;">
                                    <div class="card-body">
                                        ...
                                        $siswa = mysqli_query($conn, "SELECT * FROM tb_siswa inner join tb_walas on tb_siswa.kode_kelas=tb_walas.kode_kelas inner join tb_user on tb_user.kode_walas=tb_walas.kode_walas inner join tb_kelas on tb_siswa.kode_kelas = tb_kelas.kode_kelas where username = '$_SESSION[username]'");
