                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="container">
                            ...
                            <form action="add-fungsimapel.php" method="POST" class="needs-validation" novalidate>
                                <div class="form-group">
                                    <label for="kode">Kode Mapel :</label>
                                    <input type="text" class="form-control" id="kode" placeholder="Isikan Kode Mapel yang di inginkan" name="kode_mapel" autofocus>
                                    <div class="valid-feedback">Ok</div>
                                    <div class="invalid-feedback">silahkan input kode mapel</div>
                                </div>
                                <div class="form-group">
                                    <label for="nama">Nama Mapel :</label>
                                    <input type="text" class="form-control" id="nip" placeholder="isikan Nama Mapel" name="nama_mapel" required>
                                    <div class="valid-feedback">Ok</div>
