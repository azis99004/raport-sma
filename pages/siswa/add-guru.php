                        ...
                        <div class="container">
                            ...
                            <form action="add-fungsiguru.php" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nip" placeholder="isikan NIP anda" name="nip">
                                    <div class="valid-feedback">Ok</div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="telp" placeholder="Isikan No. Telpon Anda" name="telp_guru" required>
                                    <div class="valid-feedback">Ok</div>
