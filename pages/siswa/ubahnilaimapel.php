...
include "../koneksi.php";
if (isset($_GET['id'])) {
    $tampilnilaimapel = mysqli_query($conn, "SELECT * FROM tb_nilai_mapel WHERE id_nilai_mapel = '$_GET[id]'");
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Ubah Data Nilai Pengetahuan Siswa</h1>
                    <p class="mb-4">Silahkan ubah data pengetahuan siswa!
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="container">
                            <h2>Ubah Data Nilai pengetahuan Siswa</h2>
                            <p>Silahkan jika ingin mengubah data, lakukan dengan bijak!</p>
                            <form action="ubah-fungsinilaimapel.php" method="POST" class="needs-validation" novalidate>
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="nilai"> ID Siswa:</label>
