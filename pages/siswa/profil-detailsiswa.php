...
$guru = mysqli_query($conn, "SELECT * FROM tb_siswa inner join tb_kelas on tb_siswa.kode_kelas=tb_kelas.kode_kelas inner join tb_user on tb_user.username = tb_user.username WHERE id_siswa='$_GET[id]' AND tb_user.username = '$_SESSION[username]'");
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Detail Informasi Siswa</h1>
                    <p class="mb-4">Detail Informasi Siswa
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <table class="table table-bordered table-striped">
                            <tr>
                                <th rowspan="11px" width="170"><?php echo "<img src=\"../../img/$result[foto_siswa]\" width=\"150px\"/>" ?></th>
                                <th width="170px">NISN</th>
                                <th width="20px">: </th>
                            ...
                            <tr>
                                ...
                                <th>: </th>
                                <td align="left"><?php echo "$result[nama_kelas]"; ?></td>
                            </tr>
                            <tr>
                                <th align="left">Jurusan</th>
                                <th>: </th>
                                <td align="left"><?php echo "$result[jurusan]"; ?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <th>: </th>
                                <td align="left"><?php echo "$result[tgl_lahir]"; ?></td>
                            </tr>
                            <tr>
                                <th align="left" valign="top">Kelamin</th>
                                <th valign="top">: </th>
                                <td align="left" valign="top"><?php echo "$result[kelamin]"; ?></td>
                            </tr>
                            <tr>
                                <th align="left">Tempat Lahir</th>
                                <th>: </th>
                                <td align="left"><?php echo "$result[tempat_lahir]"; ?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th align="left">Nomor Handphone</th>
                                <th>: </th>
                                <td align="left"><?php echo "$result[no_hp]"; ?></td>
                            </tr>
                            <tr>
                        ...
                        Ubah Biodata Siswa :
                        <td>
                            <button type="button" name="ubah"><a href="ubahsiswa.php?id=<?= $result["id_siswa"] ?>"><i class="fas fa-pencil-alt"></i></a></button>
                        </td>
                        Ubah Password Siswa :
                        <td>
                            <button type="button" name="ubah"><a href="ubahpassword.php?id=<?= $result["id_user"] ?>"><i class="fas fa-pencil-alt"></i></a></button>
                        </td>
                    </div>
                    <!-- /.container-fluid -->
