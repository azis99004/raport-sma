...
$tahun = mysqli_query($conn, "SELECT * FROM tb_tahun_akademik");
$result = mysqli_fetch_assoc($tahun);
?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Pilih Tahun</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <!-- pencarian berdasar kelas -->
                                <form action="print-raport.php" method="get">
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            <label for="kelas">Tahun Akademik</label>
                                            <select name="tahun" id="" class="form-control">
                                                <option value="" readonly>--Pilih Tahun Akademik--</option>
                                                <?php foreach ($tahun as $row) : ?>
                                                    <option value="<?= $row["kode_tahun_akademik"] ?>"><?= $row["nama_tahun_akademik"] ?>-<?= $row["semester"] ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
