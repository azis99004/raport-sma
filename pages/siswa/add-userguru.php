                        ...
                        <div class="container">
                            ...
                            <form action="add-fungsiuserguru.php" method="POST" class="needs-validation" novalidate>
                                <div class="form-group">
                                    <label for="kode_guru">Nama Siswa:</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" id="password" placeholder="isikan Password" name="password">
                                        <div class="valid-feedback">Ok</div>
                                        <div class="invalid-feedback">silahkan input NIP anda</div>
                                    </div>
                                    <div class="form-group">
                                        <label for="alamat">Retype Password :</label>
                                        <input type="password" class="form-control" id="password2" placeholder="Ketik ulang password anda" name="password2" required>
                                        <div class="valid-feedback">Ok</div>
