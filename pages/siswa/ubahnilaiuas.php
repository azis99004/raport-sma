...
include "../koneksi.php";
if (isset($_GET['id'])) {
    $tampilnilaimapel = mysqli_query($conn, "SELECT * FROM tb_nilai_uas WHERE id_nilai_uas = '$_GET[id]'");
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="container">
                            ...
                            <form action="ubah-fungsinilaiuas.php" method="POST" class="needs-validation" novalidate>
                                <div class="form-group">
                                    <input type="hidden" name="id_nilai_uas" value="<?= $nilaimapel["id_nilai_uas"]; ?>">
                                    <div class="form-group">
