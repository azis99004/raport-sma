...
$walas = mysqli_query($conn, "SELECT * FROM tb_walas");
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="container">
                            ...
                            <form action="add-fungsiwalas.php" method="POST" class="needs-validation" novalidate>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="sel1" name="kode_kelas" required>
                                        ...
                                        <?php
                                        include "../koneksi.php";
                                        $tampilguru = mysqli_query($conn, "SELECT * FROM tb_kelas");
                                        while ($guru = mysqli_fetch_assoc($tampilguru)) {
                                            echo "<option value=$guru[kode_kelas]>$guru[nama_kelas]</option>";
                                        }
                                        ?>
                                    </select>
                                </div>
