...
include "../koneksi.php";
if (isset($_GET['id'])) {
    $tampilmapel = mysqli_query($conn, "SELECT * FROM tb_mapel WHERE kode_mapel = '$_GET[id]'");
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Ubah Data Mapel</h1>
                    <p class="mb-4">Silahkan ubah data-data mapel yang ingin diubah!
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="container">
                            ...
                            <form action="ubah-fungsimapel.php" method="POST" class="needs-validation" novalidate>
                                <div class="form-group">
                                    <label for="kode">Kode Mapel :</label>
                                    <input type="text" class="form-control" id="kode" placeholder="Isikan Kode Mapel yang di inginkan" name="kode_mapel" autofocus readonly value="<?php global $mapel; ?><?php echo $mapel['kode_mapel']; ?>">
                                    <div class="valid-feedback">Ok</div>
                                    <div class="invalid-feedback">silahkan input kode mapel</div>
                                </div>
                                <div class="form-group">
                                    <label for="nama">Nama mapel :</label>
                                    <input type="text" class="form-control" id="nip" placeholder="isikan Nama Anda" name="nama_mapel" value="<?= $mapel['nama_mapel']; ?>">
                                    <div class="valid-feedback">Ok</div>
                                    <div class="invalid-feedback">silahkan input Nama anda</div>
                                </div>
                                <div class="form-group">
                                    <label for="nip">Jurusan :</label>
                                    <input type="text" class="form-control" id="nip" placeholder="isikan NIP anda" name="jurusan" value="<?= $mapel['jurusan']; ?>">
                                    <div class="valid-feedback">Ok</div>
