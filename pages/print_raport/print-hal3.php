...
<body onload="window.print()">
  ...
  $walas = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM tb_user JOIN tb_walas ON tb_walas.kode_walas = tb_user.kode_walas join tb_guru on tb_walas.kode_guru = tb_guru.kode_guru where username = '$_SESSION[username]'"));
  ...
  echo "<table width=100%>
        <tr><td width=140px>Nama Sekolah</td> <td> : SMA Mutiara Insan Nusantara</td><td width=140px>Kelas / Semseter</td>   <td>: $s[nama_kelas] / $semester</td></tr>
  ...
  <table border=0 width=100%>
    <tr>
      <td width="260" align="center"><br><br><br><br><br><br><br><br><br><br>Orang Tua / Wali</td>
      <td width="520" align="center"><br><br><br><br><br><br><br><br><br>Mengetahui <br> Kepala SMA Mutiara Insan Nusantara</td>
      <td width="260" align="center"><br><br><br><br><br><br><br><br><br>Tangerang,<?php echo tgl_indo(date("Y-m-d")); ?> <br> Wali Kelas</td>
    </tr>
    <tr>
